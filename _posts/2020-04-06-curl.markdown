...
(2) CURL achieves state-of-the-art score median scores at 500k frames on DeepMind control environments that are extensively benchmarked by competing baselines - across both model-free and model-based methods. At the 500k frame benchmark, CURL matches median state-based performance.
